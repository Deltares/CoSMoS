"""Delft3D FM standalone job runner for CoSMoS.

Runs Delft3D FM model jobs on remote workers or in the cloud, including nesting,
...
def merge_ensemble(config: dict) -> None:
    ...
    fo.copy_file(
        os.path.join(folder_path, ensemble_members[0], "delft3dfm.*.rst"), folder_path
    )
